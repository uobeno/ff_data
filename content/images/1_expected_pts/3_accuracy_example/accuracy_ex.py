...
df = query('image_ep_1_accuracy_ex','accuracy_ex.sql')
...
table_fig.update_layout(
    title_text="Comparing expected PPG of draft position vs actual PPG",
...
# Save the figure
table_fig.write_image('accuracy_ex.png', scale=2, width=width, height=height)
